        ...
        <tbody>
            @foreach ($pengumpulans as $index => $pengumpulan)
                <tr>
                    ...
                    <td><a href="{{ $pengumpulan->link_tugas }}" target="_blank">{{ $pengumpulan->link_tugas }}</a></td>
                    ...
                    <td>
                        <form action="{{ route('pengumpulan.dosenUpdate', $pengumpulan->id) }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="nilai" id="nilai-{{ $pengumpulan->id }}" class="form-control" value="{{ $pengumpulan->nilai }}">
                            </div>
                            <div class="form-group">
